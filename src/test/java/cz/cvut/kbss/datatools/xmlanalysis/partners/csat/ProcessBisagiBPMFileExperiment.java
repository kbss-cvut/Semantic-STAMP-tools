...
public class ProcessBisagiBPMFileExperiment {
    @Test
...
//        new ProcessBisagiBPMFile().processFile("csat-process-models/bizagi-process-models/verze 08.11 BM Administration.bpm", null);
        new ProcessBisagiBPMFile().processFile("csat-process-models/bizagi-process-models/verze 25.10 BM Administration-001.bpm", null);
