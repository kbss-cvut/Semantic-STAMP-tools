...
import cz.cvut.kbss.reporting.model.repo.ImportEvent;
import cz.cvut.kbss.reporting.model.repo.RemoteReportRepository;
import cz.cvut.kbss.reporting.service.data.eccairs.change.EccairsReportChange;
import cz.cvut.kbss.reporting.service.data.eccairs.change.EccairsRepositoryChange;
import cz.cvut.kbss.reporting.service.data.mail.ReportImporter;
import cz.cvut.kbss.reporting.service.repository.RemoteReportRepositoryService;
    ...
    protected List<EccairsReport> importAndMatchNewReportToExisting(String reportStr){
        ...
        for(EccairsReport r : importedReports){
            ...
            if(matchedReports != null && !matchedReports.isEmpty()){
                r.getTypes().add(cz.cvut.kbss.reporting.model.Vocabulary.s_c_read_only);
            }
