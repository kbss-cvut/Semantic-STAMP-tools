...
public class E5XTerms {
    ...
    public static final String DATA_BRIDGE_FILE = "eccairs_schema/ECCAIRS5_dataBridge.xsd";
    ...
    public enum Entity implements E5XTerm {
        ...
        Entity(String xmlElementName, String eccairsId) {
    ...
    public enum OccurrenceAttribute implements E5XTerm {
        ...
        OccurrenceAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    // Aircraft attributes
    public enum AircraftAttribute implements E5XTerm {
        ...
        AircraftAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    public enum NarrativeAttribute implements E5XTerm {
        // registration relator
        ...
        NarrativeAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    public enum EventsAttribute implements E5XTerm {
        // registration relator
        ...
        EventsAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    public enum ReportingHistoryAttributes implements E5XTerm {
        ...
        ReportingHistoryAttributes(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    public enum DescriptiveFactorAttribute implements E5XTerm { // not E5X entity
        // registration relator
        ...
        DescriptiveFactorAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
    ...
    public enum ExplanatoryFactorAttribute implements E5XTerm { // not E5X entity
        // registration relator
        ...
        ExplanatoryFactorAttribute(String xmlElementName, String eccairsId) {
            this.xmlElementName = xmlElementName;
            this.eccairsId = eccairsId;
        }
