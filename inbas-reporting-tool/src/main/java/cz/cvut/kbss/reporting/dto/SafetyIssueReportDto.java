...
import cz.cvut.kbss.reporting.dto.event.SafetyIssueDto;
...
public class SafetyIssueReportDto extends AbstractReportDto {
    ...
    public ReportDto toReportDto() {
        final cz.cvut.kbss.reporting.dto.reportlist.SafetyIssueReportDto dto = new cz.cvut.kbss.reporting.dto.reportlist.SafetyIssueReportDto();
        copyAttributes(dto);
