...
class LossEventDetail extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            eventType: JsonLdUtils.jsonLdToTypeaheadOption(ObjectTypeResolver.resolveType(factor.statement.eventType, OptionsStore.getOptions(Constants.OPTIONS.LOSS_EVENT_TYPE))),
        ...
        return <div>
            ...
            <Modal show={this.props.show} onHide={this.props.onClose}>
                <Modal.Header closeButton>
                    <Modal.Title>{this.i18n('factors.loss-event.detail.title')}</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Body ref={comp => this._modalContent = comp}>
                    ...
                    <div>
                        ...
                        <div className={eventTypeClassNames}>
                            <label>{this.i18n('factors.detail.type')}</label>
                        </div>
                        <Input  value={eventTypeLabel} disabled='true'/>
                        {this._renderTemporalAttributes()}
                    </div>
                </Modal.Body>

                <Modal.Footer ref={comp => this._modalFooter = comp}>
                    <Button bsSize='small' bsStyle='success' onClick={this.onSave}>{this.i18n('save')}</Button>
...
export default injectIntl(I18nWrapper(LossEventDetail));
