...
module.exports = {
    ...
    'messages': {
        ...
        'occurrence.location.title': 'Location',
        'occurrence.location.named': 'Named',
        'occurrence.location.gps': 'GPS',
        'occurrence.location.named.name': 'Location name',
        'occurrence.location.gps.lat': 'Latitude',
        'occurrence.location.gps.long': 'Longitude',
        'occurrence.location.gps.lat.empty': 'Latitude is required for GPS location.',
        'occurrence.location.gps.long.empty': 'Longitude is required for GPS location.',
        ...
        'users.table.status.locked.tooltip': 'Account is locked!',
        'users.table.status.disabled.tooltip': 'Account is disabled',
        'users.table.status.normal.tooltip': 'Account is accessible',
        ...
        'statistics.panel.event-control-loop.dimension.deviation' : 'deviation',
        'statistics.panel.event-control-loop.dimension.controller' : 'controller',
        'statistics.panel.event-control-loop.dimension.controlled_process' : 'controlled process',
        'statistics.panel.event-control-loop.calculation.count' : 'count',
