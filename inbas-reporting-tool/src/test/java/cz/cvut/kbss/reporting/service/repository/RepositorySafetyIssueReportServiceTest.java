...
public class RepositorySafetyIssueReportServiceTest extends BaseServiceTestRunner {
    ...
    public void getLatestRevisionLoadsLatestRevisionOfSafetyIssueReport() {
        ...
        Assert.assertEquals(latest.getRevision(), result.getRevision());
    }
    ...
    public void createNewRevisionCreatesReportWithIdenticalFileNumber() {
        ...
        Assert.assertEquals(latest.getFileNumber(), newRevision.getFileNumber());
        Assert.assertEquals(latest.getRevision() + 1, newRevision.getRevision().intValue());
        Assert.assertNotEquals(latest.getKey(), newRevision.getKey());
