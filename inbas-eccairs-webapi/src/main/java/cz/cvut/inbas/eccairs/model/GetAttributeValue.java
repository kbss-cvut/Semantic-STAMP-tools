 ...
 *         &lt;element name="valueData" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "GetAttributeValue")
public class GetAttributeValue {
    ...
    @XmlElementRef(name = "valueData", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valueData;
     ...
     *     
     */
    public JAXBElement<String> getValueData() {
        return valueData;
    }
     ...
     *     
     */
    public void setValueData(JAXBElement<String> value) {
