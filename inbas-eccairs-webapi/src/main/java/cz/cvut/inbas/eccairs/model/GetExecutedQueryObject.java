...
@XmlRootElement(name = "GetExecutedQueryObject")
public class GetExecutedQueryObject {
    ...
    @XmlElementRef(name = "operationID", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
