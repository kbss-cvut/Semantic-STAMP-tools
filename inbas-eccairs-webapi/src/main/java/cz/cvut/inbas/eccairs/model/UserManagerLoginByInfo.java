...
@XmlRootElement(name = "UserManagerLoginByInfo")
public class UserManagerLoginByInfo {

    @XmlElementRef(name = "loginInfo", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
